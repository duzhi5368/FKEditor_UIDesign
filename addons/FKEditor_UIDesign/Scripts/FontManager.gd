...
extends Object
#-------------------------------------------------
const TextDict = preload("./Text_En.gd").TextDict
#-------------------------------------------------
const FONT_FILE_PATTERN = "\\.ttf$"
const FONT_WEIGHT_PATTERNS = {
	"thin": "(?i)(-|_)thin",
	"extra_light": "(?i)(-|_)(E|e)xtra(L|l)ight",
	"light": "(?i)(-|_)(L|l)ight",
	"regular": "(?i)(-|_)(R|r)egular",
	"medium": "(?i)(-|_)(M|m)edium",
	"semi_bold": "(?i)(-|_)(S|s)emi(B|b)old",
	"bold": "(?i)(-|_)(B|b)old",
	"extra_bold": "(?i)(-|_)(E|e)xtr(B|b)bold",
	"black": "(?i)(-|_)(B|b)lack",
	"extra_black": "(?i)(-|_)(E|e)xtra(B|b)lack"
}
...
func load_root_dir(root_dir):
	...
	if result == OK:
		...
		push_warning(TextDict["AccessDirFailed"] % [root_dir, result])
		return false
...
func load_fonts(dir):
	...
	if result == OK:
		...
		if not font_family.empty():
			...
			push_warning(TextDict["LoadTTFFailed"] % dir)
	else:
		push_warning(TextDict["AccessDirFailed"] % [dir, result])
		return false
